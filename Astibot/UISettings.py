...
class UISettings(QtGui.QWidget):
    ...
    STR_QLABEL_STYLESHEET = "QLabel { background-color : black; color : white; font: bold 18px;}"
    STR_QLABEL_NOTE_STYLESHEET = "QLabel { background-color : black; color : white; font: 12px;}"
    STR_QCHECKBOX_STYLESHEET = "QCheckBox { background-color : black; color : white; font: 10px;}"
    STR_QCHECKBOX_LABEL_STYLESHEET = "QLabel { background-color : black; color : #C2C2C2; font: 10px;}"
    STR_QLABEL_TITLE_STYLESHEET = "QLabel { background-color : black; color : white; font: bold 20px;}"
    STR_QTEXTEDIT_STYLESHEET = "QLineEdit { background-color : black; color : white; font: bold 18px; border: 1px solid white; border-radius: 4px;} QLineEdit:focus {border: 2px solid #007ad9;}"
    STR_QTEXTEDIT_BLINK_STYLESHEET = "QLineEdit { background-color : black; color : white; font: bold 13px; border: 3px solid #00c11a; border-radius: 4px;} QLineEdit:focus {border: 3px solid #00c11a;}"
    # STR_QFRAME_SEPARATOR_STYLESHEET = "background-color: rgb(28, 30, 28)"
    STR_COMBO_STYLESHEET = "QComboBox { background-color : black; color : white; font: bold bold 13px; border: 1px solid white; border-radius: 4px;} QComboBox:focus {border: 2px solid #007ad9;} QListView{color: white; font: bold 13px;} QListView:focus {border: 2px solid #007ad9;} QComboBox QAbstractItemView::item{min-height: 32px;}"
...
#             self.checkboxAuthorization.setChecked(False)
    ...
    def BuildWindowLayout(self):
        ...
        self.btnSave.setStyleSheet(self.STR_QBUTTON_APPLY_STYLESHEET)
        self.btnSave.setFixedWidth(140)
        self.btnSave.setFixedHeight(38)
        self.btnSave.clicked.connect(self.EventApplylButtonClick)
        self.btnSave.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.hBoxBottomButtons = QtGui.QHBoxLayout()
        self.hBoxBottomButtons.addWidget(self.btnSave, QtCore.Qt.AlignRight)
    ...
    def UIST_ShowWindow(self):
        ...
        if ((self.txtAPIKey.text() == "") or (self.txtSecretKey.text() == "")):            
